...
public class OdataReadClient {
	...
	public ArrayList<Map<String, Object>> getDiscussion(final int personId) {
	...
	public ArrayList<Map<String, Object>> getPersons() {

		ArrayList<Map<String, Object>> users = new ArrayList<Map<String, Object>>();
		// Map<String, Object> m;
		// for (OEntity person : consumer.getEntities(Person.TABLE_NAME).execute()) {
		// m = new HashMap<String, Object>();
		// m.put(person.getProperties(), person.getProperty(Person._ID).getValue());
	...
	public ArrayList<Map<String, Object>> getPoint(final int topicId) {
	...
	public OEntity getRelatedEntity(final OEntity oEntity, final String navPropertyName) {

		return consumer.getEntity(oEntity.getLink(navPropertyName, ORelatedEntityLink.class)).execute();
	}

	public ArrayList<Map<String, Object>> getTopic(final int discussionId) {
	...
	public void logServerMetaData() {
		...
		ODataReportUtil.reportMetadata(consumer.getMetadata());
	}
}
